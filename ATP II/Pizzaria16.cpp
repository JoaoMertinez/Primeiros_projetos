...
void RelatorioPizza(void)
{
	...
	else
	{
		...
		{	
			...
			printf("Codigo %d Sabor %s Status %c Valor %.2f\n",p.Cod,p.Desc,p.Status,p.Valor);
			//printf("%d",p.Cod);
			//printf("%s",p.Desc);
			//printf("%d",p.quant);//errado
...
void PizzaMaisPedida(void)
{
	...
	fseek(Ptr,0,0);
	fread(&pizza,sizeof(TpPizzas),1,Ptr);
	printf("A pizza mais pedida %d",pizza.Cod);
	printf("Sabor da pizza %s",pizza.Desc);
	printf("Quantidade de vendas %d",pizza.quant);
	printf("Valor da pizza %.2f",pizza.Valor);
	fclose(Ptr);
	getch();
}
...
void PizzaMenosPedida(void)
{
	...
	fseek(Ptr,0,2);
	fread(&pizza,sizeof(TpPizzas),1,Ptr);
	printf("A pizza menos pedida %d",pizza.Cod);
	printf("Sabor da pizza %s",pizza.Desc);
	printf("Quantidade de vendas %d",pizza.quant);
	printf("Valor da pizza %.2f",pizza.Valor);
	fclose(Ptr);
